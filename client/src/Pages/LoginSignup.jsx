  ...
  return (
    <div className=" py-4 sm:py-8 lg:py-12">
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        <form className="bg-white mx-auto max-w-lg rounded-xl border">
          <div className="flex flex-col gap-4 p-4 md:p-8">
            <h2 className="my-2 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">Login</h2>

            <div>
              <input name="username" placeholder='Your Name' className="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
            </div>

            <div>
              <input name="email" placeholder='Email Address' className="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
            </div>

            <div>
              <input name="password" placeholder='password' className="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
            </div>

            <button className="block rounded-lg bg-red-600 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-red-300 transition duration-100 hover:bg-red-800 focus-visible:ring active:bg-red-600 md:text-base">Log in</button>
